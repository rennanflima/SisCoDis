...
@ManagedBean
@RequestScoped
public class SalasBlocosPorAndar {
    ...
    public void gerarRelatorio() {
        ...
        String arquivo = context.getRealPath("WEB-INF/relatorios/salasBlocosPorAndar.jasper");
        sd = new SalasDAO();
        //passa uma ResultSet por o relatório ter sido gerado .jasper usando JDBC datasource
        Connection conn = con.abreConexao();
        ResultSet rs = sd.salasBlocosPorAndarResultSet(conn);
