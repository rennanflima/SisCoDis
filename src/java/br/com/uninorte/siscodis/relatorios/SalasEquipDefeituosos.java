...
@ManagedBean
@RequestScoped
public class SalasEquipDefeituosos {
    ...
    public void gerarRelatorio() {
        ...
        String arquivo = context.getRealPath("WEB-INF/relatorios/salasEquipDefeituosos.jasper");
        sd = new SalasDAO();
        //passa uma ResultSet por o relatório ter sido gerado .jasper usando JDBC datasource
        Connection conn = con.abreConexao();
        ResultSet rs = sd.salasEquipDefeituososResultSet(conn);
