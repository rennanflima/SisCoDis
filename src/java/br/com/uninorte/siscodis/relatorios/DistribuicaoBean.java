...
public class DistribuicaoBean {
    ...
    public void gerarRelatorio() {
        ...
        String arquivo = context.getRealPath("WEB-INF/relatorios/distribuicao.jasper");
        td = new TurmasDAO();
        //passa uma ResultSet por o relatório ter sido gerado .jasper usando JDBC datasource
        Connection conn = con.abreConexao();
        ResultSet rs = td.distribuicaoResultSet(conn);
        JRResultSetDataSource jrRS = new JRResultSetDataSource(rs);
        //está passando as imagens como parametros para o relatorio
