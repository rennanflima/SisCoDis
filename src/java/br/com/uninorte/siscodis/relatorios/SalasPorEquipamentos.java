...
@ManagedBean
@RequestScoped
public class SalasPorEquipamentos {

    private EquipamentoDaSalaDAO eqsd;
    ...
    public void gerarRelatorio() {
        ...
        String arquivo = context.getRealPath("WEB-INF/relatorios/salaPorEquipamento.jasper");
        eqsd = new EquipamentoDaSalaDAO();
        ...
        if (idEquipamentos == null) {
            rs = eqsd.salasPorEquipamentosTodosResultSet(conn);
        } else{
            rs = eqsd.salasPorEquipamentosResultSet(conn, idEquipamentos);
        }
